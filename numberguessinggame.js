...
function setGameOver() {
    ...
    btnSubmit.textContent = "RESET!"
    btnSubmit.removeEventListener("click", checkGuess);
    btnSubmit.addEventListener("click", resetgame);
}
...
function resetgame() {
    ...
    userinput.value = "";
    result.textContent = "";
    btnSubmit.removeEventListener("click", resetgame);
    btnSubmit.addEventListener("click", checkGuess);
